		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarColor02">
				<ul class="navbar-nav me-auto">
					...
					<li class="nav-item"><a class="nav-link active" href="http://localhost:8080/countries">Countries</a>
					</li>
			...
			<c:forEach items="${item.countryInfo}" var="entry">
				<div class="card text-white bg-dark border-light mb-3" id="card"
					...
					<div class="card-header">
						<img SRC="${entry.flag}" width="55" height="35"
							style="margin-right: 10px;"> ${entry.iso3}
					</div>
					<div class="card-body">
						<h4 class="card-title">
							<a href="country/${item.country}" target="_blank"
								style="color: orange;"> <strong>${item.country}</strong></a>
						</h4>
						<p class="card-text">
							...
							<br> 
							Today recovered : ${item.todayRecovered}
						</p>
					</div>
				</div>
			</c:forEach>
