		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarColor02">
				<ul class="navbar-nav me-auto">
					...
					<li class="nav-item dropdown"> <a class="nav-link active dropdown-toggle" data-bs-toggle="dropdown"
						...
						<thead>
							...
							<tr>
								<c:forEach items="${item.continentInfo}" var="entry">
									<th scope="col">Continent Info</th>
									<th scope="col">Latitude: ${entry.latitude} <br>
			...
			<div class="card text-white bg-dark border-light mb-3" id="card"
				...
				<div class="card-body">
					...
					<table class="table align-middle">
						<thead>
							<tr>
								<th scope="col">${item.countries}<br></th>
							</tr>
						</thead>
					</table>
				</div>
