...
<table class="table align-middle">
	...
	<tr>
		<th scope="col"><img SRC="${entry.flag}" width="200" height="117"><th scope="col">Continent: ${item.continent} <br>
																						Country: ${item.country} </th>
	</tr>
	<tr>
	<th scope="col">Country info</th><th scope="col">ID: ${entry._id} <br> ISO2: ${entry.iso2} <br> ISO3: ${entry.iso3} <br>
		  			Latitude: ${entry.latitude} <br> Longitude: ${entry.longitude}
	</th>
	</tr>
	</c:forEach>
		    <tr>
