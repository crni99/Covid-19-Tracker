	...
	<div
		...
		<c:forEach items="${country}" var="item">
			<c:forEach items="${item.countryInfo}" var="entry">
				...
				<div class="card text-white bg-dark border-light mb-3" id="card"
					...
					<div class="card-body">
						...
						<table class="table align-middle" id="table">
							<thead>
								<tr>
									<th scope="col"><img SRC="${entry.flag}" width="200"
										height="117">
									<th scope="col">
								</tr>
								<tr>
								...
								<tr>
									<th scope="col">Recovered Per One Million</th>
									<th scope="col">${item.recoveredPerOneMillion}</th>
								</tr>
								<tr>
									<th scope="col">Active Per One Million</th>
									<th scope="col">${item.activePerOneMillion}</th>
								</tr>
								<tr>
									<th scope="col">Ctitical Per One Million</th>
				...
				<div class="card text-white bg-dark border-light mb-3" id="card"
					style="margin: 10px; max-width: 60rem; width: 960px;">
					<div class="card-header" style="text-align: center;">Continent
						Info</div>
					<div class="card-body">
						<p class="card-text">
						<table class="table align-middle">
							<thead>
								<tr>
									...
									<th scope="col">${entry.iso2}</th>
								</tr>
								<tr>
									<th scope="col">ISO3</th>
									<th scope="col">${entry.iso3}</th>
								</tr>
								<tr>
									<th scope="col">Latitude</th>
									<th scope="col">${entry.latitude}</th>
								</tr>
								<tr>
									<th scope="col">Longitude</th>
									<th scope="col">${entry.longitude}</th>
								</tr>
								<tr>
